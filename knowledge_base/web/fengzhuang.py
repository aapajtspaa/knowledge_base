...
def fengzhuang(x):
    file = open('machine learning/test1/待分类文本/1.txt', 'w+', encoding='UTF-8')
    a = x
    print(a, file=file)
    file.close()

    file = open('machine learning/test1/待分类文本/1.txt', 'r', encoding='UTF-8')
    sent = file.read()
    sent_list = jieba.cut(sent)
    #
    file0 = open('machine learning/split/test_split/待分类文本/1.txt', 'w+', encoding='UTF-8')
...
datapath = "./machine learning/data/"  # 原始数据路径
stopWord_path = "./machine learning/stop/stopword.txt"  # 停用词路径
test_path = "./machine learning/test1/"  # 测试集路径
test_split_dat_path = "./machine learning/test_set.dat"  # 测试集分词bat文件路径
testspace_dat_path = "./machine learning/testspace.dat"  # 测试集输出空间矩阵dat文件
train_dat_path = "./machine learning/train_set.dat"  # 读取分词数据之后的词向量并保存为二进制文件
tfidfspace_dat_path = "./machine learning/tfidfspace.dat"  # tf-idf词频空间向量的dat文件
test_split_path = './machine learning/split/test_split/'  # 测试集分词路径
split_datapath = "./machine learning/split/split_data/"  # 对原始数据分词之后的数据路径
testSpace_path = "./machine learning/testSpace.txt"  # 测试集分词信息
testSpace_arr_path = "./machine learning/testSpace_arr.txt"  # 测试集词频矩阵信息
trainbunch_vocabulary_path = "./machine learning/trainbunch_vocabulary.txt"  # 所有分词词频信息
tfidfspace_out_arr_path = "./machine learning/tfidfspace_out_arr.txt"  # tfidf输出矩阵信息
tfidfspace_out_word_path = "./machine learning/tfidfspace_out_word.txt"  # 单词形式的txt
testspace_out_arr_path = "./machine learning/testspace_out_arr.txt"  # 测试集输出矩阵信息
testspace_out_word_apth = "./machine learning/testspace_out_word.txt"  # 测试界单词信息
# 输入训练集
